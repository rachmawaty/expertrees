...
<body>
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">ExperTrees</a>
        </div>
        ...
        -->
            <div class="container">
                <header class="jumbotron hero-spacer">
                    <h1>Selamat datang di ExperTrees</h1>
                    <p>
                        Expertrees adalah tempatmu untuk memulai bercocok tanam.
                    </p>
                    <p>
                       <!-- <a class="btn btn-primary btn-large">GO!</a> -->
                    </p>
                </header>
            </div>
        </div>        
